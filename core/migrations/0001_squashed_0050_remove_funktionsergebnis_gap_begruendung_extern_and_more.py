    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('parser_mode', models.CharField(choices=[('auto', 'Automatisch'), ('table_only', 'Nur Tabellen'), ('text_only', 'Nur Text')], default='auto', max_length=20)),
                ('parser_order', models.JSONField(default=list, help_text='Reihenfolge der zu verwendenden Parser.')),
                ('text_technisch_verfuegbar_true', models.JSONField(default=list, help_text='Reihenfolge der zu verwendenden Parser.')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('classification_json', models.JSONField(blank=True, null=True, verbose_name='Klassifizierung')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('analysis_json', models.JSONField(blank=True, null=True, verbose_name='Analyse')),
                ...
                ('verification_json', models.JSONField(blank=True, help_text='Ergebnis der KI-gestützten Verifizierung der Funktionen.', null=True)),
                ...
                ('projekt', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='anlagen', to='core.bvproject')),
            ],
            options={
                'ordering': ['anlage_nr'],
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('projekt', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='softwareknowledge', to='core.bvproject')),
            ],
            options={
        ...
        migrations.AddField(
            model_name='tile',
            name='parent',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='children', to='core.tile', verbose_name='Übergeordnete Kachel'),
        ),
        migrations.AddField(
            model_name='tile',
            name='permission',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ziel_feld', models.CharField(choices=[('technisch_verfuegbar', 'Technisch verfügbar'), ('einsatz_telefonica', 'Einsatz Telefónica'), ('zur_lv_kontrolle', 'Zur LV-Kontrolle'), ('ki_beteiligung', 'KI-Beteiligung')], max_length=50)),
        ...
        migrations.AddField(
            ...
            name='anlage4_config',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='core.anlage4config'),
        ),
        migrations.CreateModel(
        ...
        migrations.AddField(
            ...
            field=models.CharField(blank=True, help_text='ID des laufenden Verifizierungstasks.', max_length=50),
        ),
        migrations.CreateModel(
        ...
        migrations.AddField(
            ...
            field=models.JSONField(default=list, help_text='Phrasen für Einsatz bei Telefónica = Nein'),
        ),
        migrations.AddField(
            model_name='anlage2config',
            name='text_einsatz_telefonica_true',
            field=models.JSONField(default=list, help_text='Phrasen für Einsatz bei Telefónica = Ja'),
        ),
        migrations.AddField(
            model_name='anlage2config',
            name='text_ki_beteiligung_false',
            field=models.JSONField(default=list, help_text='Phrasen für KI-Beteiligung = Nein'),
        ),
        migrations.AddField(
            model_name='anlage2config',
            name='text_ki_beteiligung_true',
            field=models.JSONField(default=list, help_text='Phrasen für KI-Beteiligung = Ja'),
        ),
        migrations.AddField(
            model_name='anlage2config',
            name='text_technisch_verfuegbar_false',
            field=models.JSONField(default=list, help_text='Phrasen für technisch verfügbar = Nein'),
        ),
        migrations.AddField(
            model_name='anlage2config',
            name='text_zur_lv_kontrolle_false',
            field=models.JSONField(default=list, help_text='Phrasen für zur LV-Kontrolle = Nein'),
        ),
        migrations.AddField(
            model_name='anlage2config',
            name='text_zur_lv_kontrolle_true',
            field=models.JSONField(default=list, help_text='Phrasen für zur LV-Kontrolle = Ja'),
        ),
        migrations.AlterField(
            model_name='anlage2config',
            name='text_technisch_verfuegbar_true',
            field=models.JSONField(default=list, help_text='Phrasen für technisch verfügbar = Ja'),
        ),
        migrations.AddField(
            model_name='anlage2functionresult',
        ...
        migrations.AddField(
            ...
            field=models.CharField(choices=[('Hauptfunktion', 'Hauptfunktion'), ('Unterfrage', 'Unterfrage')], default='Hauptfunktion', max_length=20),
        ),
        migrations.AddField(
            model_name='anlage2functionresult',
        ...
        migrations.AddField(
            model_name='antworterkennungsregel',
            name='actions_json',
            field=models.JSONField(blank=True, default=dict, help_text='Feld-Wert-Paare für den exakten Parser.'),
        ),
        migrations.AddField(
            model_name='bvprojectfile',
            name='parser_mode',
            field=models.CharField(blank=True, choices=[('auto', 'Automatisch'), ('table_only', 'Nur Tabellen'), ('text_only', 'Nur Text'), ('exact_only', 'Nur Exakt')], default='', help_text='Spezifischer Parser-Modus für diese Anlage.', max_length=20),
        ),
        migrations.AddField(
            model_name='bvprojectfile',
            name='parser_order',
            field=models.JSONField(blank=True, default=list, help_text='Reihenfolge der Parser für diese Anlage.'),
        ),
        migrations.AlterField(
            model_name='anlage2config',
            name='parser_mode',
        ...
        migrations.AlterField(
            model_name='anlage2config',
            name='parser_order',
            field=models.JSONField(default=core.models.Anlage2Config.default_parser_order, help_text='Reihenfolge der zu verwendenden Parser.'),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            model_name='bvprojectfile',
            name='parent',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='children', to='core.bvprojectfile'),
        ),
        migrations.AddField(
            model_name='bvprojectfile',
            name='version',
        ...
        migrations.AddField(
            ...
            field=models.CharField(choices=[('PENDING', 'Ausstehend'), ('PROCESSING', 'In Bearbeitung'), ('COMPLETE', 'Abgeschlossen'), ('FAILED', 'Fehlgeschlagen')], default='PENDING', max_length=20),
        ),
        migrations.AddField(
            model_name='prompt',
            name='use_project_context',
            field=models.BooleanField(default=True, help_text='Soll diesem Prompt automatisch der Projekt-Kontext vorangestellt werden?'),
        ),
        migrations.AddField(
            model_name='bvprojectfile',
            name='created_at',
