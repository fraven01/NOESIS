...
urlpatterns = [
    ...
    path('projects-admin/<int:pk>/cleanup/', views.admin_project_cleanup, name='admin_project_cleanup'),
    ...
    path('work/projekte/<int:pk>/gutachten/view/', views.gutachten_view, name='gutachten_view'),
    path('work/projekte/<int:pk>/gutachten/edit/', views.gutachten_edit, name='gutachten_edit'),
    path('work/projekte/<int:pk>/gutachten/delete/', views.gutachten_delete, name='gutachten_delete'),
